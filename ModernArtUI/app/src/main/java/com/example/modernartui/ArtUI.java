...
public class ArtUI extends ActionBarActivity {

    int randomColor;
    int randomTime;
    android.os.Handler customHandler = new android.os.Handler();
    private static final String TAG = ArtUI.class.getName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_art_ui);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
            ...
            inflater.inflate(R.menu.menu_art_ui, menu);
            return true;
        }
